...
# Mac based user code - has Pytest - related code for tester purposes.
# Load YOLOv8 model
...
# Gun detection function (used in test and live mode)
...
# ONLY RUN THIS WHEN EXECUTING THE FILE DIRECTLY
if __name__ == "__main__":
    ...
    while True:
        ...
        cv2.putText(nv_frame, f"EVST NVG HUD MK 2 - {time.strftime('%H:%M:%S')}", (10, 30),
